...
<x-app-layout>
    <div class="container mx-auto mt-10">
        ...
        <div class="flex justify-center space-x-8 mb-6">
            <a href="#" class="text-lg font-medium text-gray-700 hover:text-gray-900">Inicio</a>
        ...
        <div class="text-center">
            ...
            <!-- Botón de Reporte -->
            <a href="#" class="px-6 py-3 bg-black text-gray font-semibold rounded-lg hover:bg-gray-900">
